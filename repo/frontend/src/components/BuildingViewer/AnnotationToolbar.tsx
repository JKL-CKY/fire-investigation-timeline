import { Flame, CloudAlert, MousePointer2, TriangleAlert, Footprints } from 'lucide-react'
...
const tools: { id: AnnotationTool; label: string; icon: React.ElementType; color: string }[] = [
  ...
  { id: 'smoke_path', label: '烟气路径', icon: CloudAlert, color: 'text-gray-500' },
  { id: 'evacuation_route', label: '疏散路线', icon: Footprints, color: 'text-green-500' },
  { id: 'hazard', label: '危险源', icon: TriangleAlert, color: 'text-red-500' },
]
